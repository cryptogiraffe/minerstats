...
$gfxcards = array(
  ...
  */
  'CPU i7 4770 OC' => array( // 104x39 -- 4056MHz vs stock 3900MHz
    ...
    "axiom"         =>         81 / 1000, // cpuminer-opt
    "bastion"       =>     160870 / 1000, // cpuminer-opt (manual benchmark)
    "blake"         =>   21651160 / 1000, // cpuminer-nicehash
    "blake256r8vnl" =>   30879202 / 1000, // cpuminer-opt (manual benchmark)
    "blake2s"       =>   17354603 / 1000, // cpuminer-nicehash
    "blakecoin"     =>   30981989 / 1000, // cpuminer-nicehash
    "bmw"           =>   10006416 / 1000, // cpuminer-nicehash
    "c11"           =>     700000 / 1000, // cpuminer-opt (manual benchmark)
    "cryptolight"   =>        586 / 1000, // cpuminer-opt
    "cryptonight"   =>        154 / 1000, // cpuminer-nicehash
    "decred"        =>   21218982 / 1000, // cpuminer-opt
    "dmd-gr"        =>    1120000 / 1000, // cpuminer-opt (manual benchmark)
    "drop"          =>     950000 / 1000, // cpuminer-opt (manual benchmark)
    "fresh"         =>     504900 / 1000, // cpuminer-opt (manual benchmark)
    "groestl"       =>    1120000 / 1000, // cpuminer-opt (manual benchmark)
    "heavy"         =>     238524 / 1000, // cpuminer-nicehash
    "hodl"          =>        203 / 1000, // cpuminer-opt
    "keccak"        =>    8410167 / 1000, // cpuminer-nicehash
    "luffa"         =>    3143790 / 1000, // cpuminer-opt (manual benchmark)
    "lyra2"         =>     900000 / 1000, // cpuminer-nicehash
    "lyra2v2"       =>     489810 / 1000, // cpuminer-opt (manual benchmark)
    "myr-gr"        =>    3444170 / 1000, // cpuminer-opt (manual benchmark)
    "neoscrypt"     =>      29576 / 1000, // cpuminer-nicehash
    "nist5"         =>    1893710 / 1000, // cpuminer-opt (manual benchmark)
    "pentablake"    =>    3696471 / 1000, // cpuminer-nicehash
    "pluck"         =>       1846 / 1000, // cpuminer-nicehash
    "quark"         =>    1127140 / 1000, // cpuminer-opt (manual benchmark)
    "qubit"         =>    1032520 / 1000, // cpuminer-opt (manual benchmark)
    "s3"            =>    1204130 / 1000, // cpuminer-opt (manual benchmark)
    "scrypt"        =>     101753 / 1000, // cpuminer-nicehash
    "scryptjane:16" =>        218 / 1000, // cpuminer-nicehash
    "sha256d"       =>   55947549 / 1000, // cpuminer-nicehash
    "shavite3"      =>    2356370 / 1000, // cpuminer-opt (manual benchmark)
    "sib"           =>     483720 / 1000, // cpuminer-opt (manual benchmark)
    "skein"         =>    6698627 / 1000, // cpuminer-nicehash
    "skein2"        =>    8343397 / 1000, // cpuminer-nicehash
    "vanilla"       =>   31375019 / 1000, // cpuminer-opt
    "x11"           =>     712335 / 1000, // cpuminer-opt
    "x13"           =>     348030 / 1000, // cpuminer-opt (manual benchmark)
    "x14"           =>     321442 / 1000, // cpuminer-opt
    "x15"           =>     378507 / 1000, // cpuminer-opt
    "x17"           =>     363301 / 1000, // cpuminer-opt
    "yescrypt"      =>       3493 / 1000, // cpuminer-opt
    "zr5"           =>     808311 / 1000, // cpuminer-opt
  ),
  'CPU i7 2600K' => array(
